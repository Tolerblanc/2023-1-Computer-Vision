...
int	main()
{
	...
	// bitwise AND RGB channels, convert gray to bgr to concatenate with original image
	...
	// convert gray to bgr to concatenate with original image
